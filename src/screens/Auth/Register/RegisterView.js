            ...
            <CustomKeyboardAvoidingView style={{ flex: 1, justifyContent: "space-between" }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: "space-between", alignItems: 'center' }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <Text style={{ fontFamily: 'BebasBold', fontSize: scale(35), color: 'white' }}>CASHFLOW</Text>
                        <Image style={{ height: scale(25), width: scale(25), marginLeft: scale(5), marginBottom: scale(8) }} source={require('../../../../assets/logoClear.png')} />
                    </View>
