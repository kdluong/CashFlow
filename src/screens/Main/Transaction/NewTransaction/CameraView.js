...
const CameraView = ({ bottomSheetRef, setPicture, showCamera }) => {
                ...
                >
                    ...
                    <View
                        ...
                        <TouchableOpacity
                            ...
                            disabled={type === CameraType.back ? false : true}
                        >
                            <Ionicons name={flashMode == 'off' ? 'flash-off-sharp' : 'flash-sharp'} size={scale(25)} color={type === CameraType.back ? 'white' : 'black'} />
                        </TouchableOpacity>

                        {/* Capture */}

                        <View
                            style={{ height: scale(65), width: scale(65), backgroundColor: 'black', borderRadius: 100, borderColor: 'white', borderWidth: scale(2), alignItems: "center", justifyContent: "center" }}
                        >
                            <TouchableOpacity
                                style={{ height: scale(55), width: scale(55), backgroundColor: 'white', borderRadius: 100 }}
                                onPress={() => { takePicture() }}
                            />
                        </View>
