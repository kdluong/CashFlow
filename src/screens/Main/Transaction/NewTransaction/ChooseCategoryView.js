...
const ChooseCategoryView = ({ navigation, route }) => {
    ...
    const renderHeader = () => {
        return (
            <View style={{ gap: scale(15) }}>
                ...
                <SearchPicker border={undefined} setFilter={setFilter} setSort={setSort} option={'categoryOption'} />
    ...
    const renderItem = ({ item }) => {
        return (
            ...
            >
                ...
                <Ionicons
                    name={selectedCategoryId != null && selectedCategoryId == item.id ? "checkmark-circle-sharp" : "checkmark-circle-outline"}
                    size={scale(25)}
