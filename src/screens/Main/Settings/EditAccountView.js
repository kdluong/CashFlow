...
const EditAccountView = ({ navigation, route }) => {
        ...
        <View style={{ flex: 1, backgroundColor: backgroundColor }}>
            <CustomKeyboardAvoidingView style={{ flex: 1, justifyContent: 'space-between' }}>
                ...
                < View style={{ gap: scale(10) }}>
                    ...
                    <CustomTextInput value={newValue} onChangeText={setNewValue} placeholder={option == 'email' ? "Enter a new email address" : "Enter a new password"} loading={loading} />

                    {
                        option != 'password' &&
                        <CustomTextInput value={confirmEmail} onChangeText={setConfirmEmail} placeholder={"Confirm new email address"} loading={loading} />
                    }

                    {
                        option == 'password' &&
                        <CustomTextInput value={confirmPassword} onChangeText={setConfirmPassword} placeholder={"Confirm new password"} loading={loading} />
                    }
