...
const EditProfileView = ({ navigation }: { navigation: any }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: backgroundColor }}>
...

                    {
                        loading
                            ...
                            <TouchableOpacity
                                ...
                                disabled={!isValid()}
                            >
                                <Ionicons name="checkmark-done-sharp" size={scale(22)} color={isValid() ? green : 'gray'} />
                            </TouchableOpacity>
                    }
                ...
                <View style={{ flex: 1, justifyContent: 'space-evenly' }}>
                    ...
                    <View style={{ gap: scale(15) }}>

                        {
                            picture == null
                                ...
                                <Image
                                    ...
                                    style={{ height: scale(130), width: scale(130), borderRadius: 100, borderWidth: scale(3), borderColor: 'white', alignSelf: 'center' }}
                                />
                                :
                                <Image
                                    source={picture}
                        ...
                        <View style={{ flexDirection: 'row', gap: scale(15), alignSelf: 'center' }}>
                            ...
                            <TouchableOpacity
                                onPress={() => openPicker()}
                                style={{ backgroundColor: 'white', height: scale(32), width: scale(32), borderRadius: scale(8), alignItems: 'center', justifyContent: "center" }}
                                disabled={loading}
                            >
                            ...
                            <TouchableOpacity
                                ...
                                style={{ backgroundColor: (picture == null ? 'gray' : 'red'), height: scale(32), width: scale(32), borderRadius: scale(8), alignItems: 'center', justifyContent: "center" }}
                    ...
                    <View style={{ gap: scale(10) }}>
                        ...
                        <CustomTextInput border={undefined} value={firstName} onChangeText={setFirstName} placeholder={"Enter a first name"} loading={loading} />

                        <CustomTextInput border={undefined} value={lastName} onChangeText={setLastName} placeholder={"Enter a last name"} loading={loading} />
            ...
            >
                <CameraView bottomSheetRef={bottomSheetRef} setPicture={setPicture} showCamera={showCamera} />
            </BottomSheet>
